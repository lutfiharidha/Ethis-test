...
<body>
    <nav class="uk-navbar-container" uk-navbar>
        ...
        <div class="uk-navbar-left uk-margin-left">
            <a class="uk-navbar-item uk-logo" href="{{ url('/home') }}">Laravel News</a>
        </div>
        ...
        <div class="uk-navbar-right">
            ...
            <ul class="uk-navbar-nav uk-margin-right">
                <li id="notification">
                    <a href="#">
                        <span class="@if(count(auth()->user()->unreadNotifications) > 0) uk-badge @endif"
                            uk-icon="icon:bell">
                    </a>
                        ...
                        <ul id="show" class="uk-nav uk-navbar-dropdown-nav">
                            ...
                            <li class="notif">
                                <a class="mark-as-read" href="#" data-id="{{ $notif->id }}">
                                    <b>{{ $notif->data['author'] }}</b> was just created news about
                                    <b>{{ str_limit($notif->data['news']['title'], $limit = 15, $end = '...')  }}</b><br>
                ...
                <li>
                    ...
                    <div class="uk-navbar-dropdown">
                        <ul class="uk-nav uk-navbar-dropdown-nav">
                            ...
                            <li><a href="{{ route('news.add') }}">Add News</a></li>
                        </ul>
                    </div>
                </li>
